...
public class ItemActivity extends Activity {
    ...
    public void addListenerOnPartialClaim() {

        partialClaim = (CheckBox) findViewById(R.id.partialClaim);

        partialClaim.setOnClickListener(new OnClickListener() {

            @Override
            public void onClick(View v) {
                //is partial claim checked?
                if (((CheckBox) v).isChecked()) {
                    Toast.makeText(ItemActivity.this,
                            "You have partially claimed the item", Toast.LENGTH_LONG).show();
                }
